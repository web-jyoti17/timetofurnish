...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::get('/product-import-demo', 'demoFile')->name('product_demo_file');
...
// Seller Export
Route::get('sellers/export/{id}',
    [App\Http\Controllers\SellerController::class, 'exportSingle']
)->name('admin.sellers.export_single');
...
Route::resource('sellers', SellerController::class);
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::any('/sellers/sales/export', 'sellerSaleExport')->name('sellers.sale.export');
    });
