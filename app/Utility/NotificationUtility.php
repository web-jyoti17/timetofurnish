...
class NotificationUtility
{
    ...
    public static function sendOrderNotification($order, $order_status)
    {        
        ...
        $array['seller_id'] = $order->seller_id;
        $array['status'] = $order_status;
        $array['view'] = 'emails.order_status';
        $array['subject'] = translate('Order  ') . ' - ' . $order->code.translate('  updated:') . ' - ' . $order_status;
