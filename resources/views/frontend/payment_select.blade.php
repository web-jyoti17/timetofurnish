                    ...
                    <div class="row gutters-5 sm-gutters-10">
                        ...
                        <div class="col done">
                            <div class="text-center border border-bottom-6px p-2 text-success">
                                ...
                                <h3 class="fs-14 fw-600 d-none d-lg-block"><a
                                        href="{{ url('checkout') }}">{{ translate('2. Shipping info') }}</a>
                                </h3>
                            </div>
                        </div>
                        <div class="col done">
                    ...
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="card-header p-1 border-bottom-0">
                                <h3 class="fs-16 fw-700 text-dark mb-0" style="text-align: center;margin-left: 90px;">
                                    {{ translate('Pay securely with ') }}
                                </h3>
                            </div>
                                    ...
                                    @if (get_setting('stripe_payment') == 1)
                                        ...
                                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                            ...
                                            <label class="aiz-megabox d-block mb-3">
                                                ...
                                                <!--<span class="d-block text-center">-->
                                                <!--    <span class="d-block fw-600 fs-15">{{ translate('V') }}</span>-->
                                                <!--</span>-->

                                                <!-- <span class="d-block fw-600 fs-15 mt-5">-->
...
<style>
    ...
    @media (max-width: 767px) {
        ...
        /* Remove bottom button row margin */
        .row.align-items-center {
            margin-bottom: 0 !important;
        }

        /* Reduce payment box padding */
        .aiz-megabox-elem {
            border: none !important;
            box-shadow: none !important;
            padding: 10px !important;
...
@section('script')
    <script type="text/javascript">
        ...
        const total_order_value = {{ $total }};
        const shippingRates = @json($shipping_rates);

        function calculateShipping(weight, total_order_value, deliveryOption) {
            let shippingRate;
            shippingRates.forEach(rate => {
                if (rate.name == deliveryOption) {
                    /*if (total_order_value >= rate.free_threshold && rate.free_threshold !== null) {
                      shippingRate = 0;
                    } else*/
        ...
        $(document).ready(function() {
            ...
            $('#delivery_option').on('change', function() {
                ...
                const shippingRate = calculateShipping(weight, total_order_value, deliveryOption);
                $('#shipping_rate').html(shippingRate);
                $('#shipping_rate_display').html('Shipping Rate: £' + shippingRate);
                let subtotal = parseFloat(document.getElementById('sub_total').value);
                let gtotal = (parseFloat(subtotal) + parseFloat(shippingRate)).toFixed(2);
