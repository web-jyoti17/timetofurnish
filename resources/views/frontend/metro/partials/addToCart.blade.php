    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="text-left">
                ...
                <div class="mt-3">
                    @if ($product->digital == 1)
                        <button type="button" class="btn  rounded-0 buy-now fw-600 add-to-cart" onclick="addToCart()">
                            <i class="la la-shopping-cart"></i>
                            <span class="d-none d-md-inline-block">{{ translate('Add to Basket ')}}</span>
                        </button>
                    @elseif($qty > 0)
                        ...
                        @else
                            <button type="button" class="btn borderbtn rounded-0 buy-now fw-600 add-to-cart" onclick="addToCart()">
                                <i class="la la-shopping-cart"></i>
                                <span class="d-none d-md-inline-block">{{ translate('Add to Basket')}}</span>
                            </button>
                        @endif
