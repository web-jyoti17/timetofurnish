                        ...
                        <div class="card shadow-none rounded-0 border">
                            <div class="row">
                                            ...
                                            <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <label class="aiz-checkbox">
                                                        ...
                                                        <p>I confirm that I have read and accept all    <a href="javascript:void:0" id="openModalBtn" data-id="5">  <b> Customer Terms and Conditions.</b></a></p>
                                                ...
                                                <!-- Submit Button -->
                                                <div class="mb-4 mt-4">
                                                    <button type="submit" class="btn borderbtn  btn-block fw-600 rounded-4">{{  translate('Create Account') }}</button>
                                                </div>
                                            </form>
                                ...
                                <div class="col-lg-6 col-md-5 py-3 py-md-0">
                                    <img src="{{ uploaded_asset(get_setting('register_page_image')) }}" alt="" class="img-fluid h-100 custom-login-image">
                                </div>--}}
                                <!-- Right Side Image -->
                                      <div class="col-lg-6 col-md-5 py-3 py-md-0">
                                              <img src="{{asset('public/assets/img/userlogin.jpg')}}" alt="User Login Image" class="img-fluid h-100 custom-login-image">
                                                      </div>
