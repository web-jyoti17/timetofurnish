...
class HomeController extends Controller
{
    ...
    public function handleShiprocketWebhook(Request $request)
    {
        ...
        //     'x-api-key' => 'required|string', // Validate the security token
        //     'Content-Type' => 'required|string|in:application/json',
        // ]);

        // Retrieve the webhook payload
        // $payload = $request->json()->all();

        // Process the webhook payload here (e.g., update order status, send notifications, etc.)
        // ...
