    ...
    <div class="p-3">
       ...
       {{--   <div class="row">
        ...
        @if (get_setting('google_map') == 1)
            <div class="row">
                ...
                <ul id="geoData">
                    ...
                    <li style="display: none;">{{ translate('Post Code') }}: <span id="postal_code"></span></li>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Post Code')}}" value="{{ $address_data->postal_code }}" name="postal_code" value="" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
