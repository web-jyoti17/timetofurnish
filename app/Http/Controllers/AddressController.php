...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'flat'=>'required',
        'phone' => ['required', 'regex:/^0044[0-9]{10}$/'],
        ...
        $address->landline_no =$request->landline_no;
        $address->save();
    ...
    public function addShippingCost(Request $request)
    {
        ...
        $shipping->order_total = $request->order_total;
        $shipping->shipping_1 = $request->shipping_1;
        $shipping->shipping_2 = $request->shipping_2;
        $shipping->shipping_3 = $request->shipping_3;
        $shipping->save();

        flash(translate('Shipping charges updated.'))->success();
        return back();
    }
}
