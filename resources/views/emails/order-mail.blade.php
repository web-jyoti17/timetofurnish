                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td style="font-size:12px; color:#333; padding-right:18px; white-space:nowrap;">
                                        <img src="{{ asset('assets/img/order-emails/email.jpeg') }}" width="14"
                                            height="14" alt="Email" style="vertical-align:middle;">
                                        {{ $companyEmail }}
                                    </td>
                                    <td style="font-size:12px; color:#333; padding-right:18px; white-space:nowrap;">
                                        <img src="{{ asset('assets/img/order-emails/website.jpeg') }}" width="14"
                                            height="14" alt="Website" style="vertical-align:middle;">
                                        {{ $companyWebsite }}
                                    </td>
                                    <td style="font-size:12px; color:#333; white-space:nowrap;">
                                        <img src="{{ asset('assets/img/order-emails/whatsapp.jpeg') }}"
