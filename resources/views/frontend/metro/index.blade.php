...
<div class="home-banner-area">
    <div class="p-0">
        ...
        <div class="home-slider slider-full">
            ...
            <div class="aiz-carousel home_banner_img dots-inside-bottom mobile-img-auto-height" data-dots="true" data-autoplay="true"
                data-infinite="true">
                @php
                ...
                <div class="carousel-box">
                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                        <!-- Image -->
                        <div
                            class="d-block mw-100 img-fit overflow-hidden home_slider_img overflow-hidden">
...
$flash_deal_banner_menu_text = ((get_setting('flash_deal_banner_menu_text') == 'dark') ||
(get_setting('flash_deal_banner_menu_text') == null)) ? 'text-dark' : 'text-white';
            ...
            <div class="col-xxl-8 col-lg-7 col-6">
                <div class="pl-3 pr-lg-3 pl-xl-2rem pr-xl-2rem">
                    ...
                    <div class="aiz-carousel border-top @if (count($flash_deal_products) > 8) border-right @endif arrow-inactive-none arrow-x-0"
                        ...
                        $end = 1;
                        @endphp
                        @for ($i = 0; $i < 5; $i++) <div class="carousel-box bg-white @if ($i == 0) border-left @endif">
                            @foreach ($flash_deal_products as $key => $flash_deal_product)
                            @if ($key >= $init && $key <= $end) @if ($flash_deal_product->product != null &&
                                $flash_deal_product->product->published != 0)
                                @php
                                ...
                                <div
                                    ...
                                    <a href="{{ $product_url }}" class="d-block py-md-2 overflow-hidden hov-scale-img"
                                        ...
                                        <div
                                            ...
                                            @if (home_base_price($flash_deal_product->product) !=
...
@endphp
<div id="todays_deal" class="mb-2rem mt-4 " @if(get_setting('todays_deal_section_bg')==1)
    style="background: {{ $todays_deal_section_bg }};" @endif>
...
<!-- Featured Products -->
<div id="section_featured" class="pt-5 pb-5 bg-light" >
