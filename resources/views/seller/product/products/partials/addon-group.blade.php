...
<div class="addon-block card border mb-4 shadow-none {{ $isGlobal ?? false ? 'is-global-addon' : '' }}">
        ...
        <div class="d-flex align-items-center justify-content-between" style="width:100%;">
            ...
            <div class="d-flex align-items-center">
                ...
                <label class="aiz-switch aiz-switch-success mb-0 mr-3 p-0">
                    ...
                    <input type="checkbox" class="group-toggle" name="addons[{{ $index }}][id]"
                        value="{{ $addon['id'] ?? 'new' }}" {{ $isChecked ? 'checked' : '' }}>
                ...
                <input type="text" name="addons[{{ $index }}][name]"
                    ...
                    class="form-control border-0 bg-transparent font-weight-bold group-name p-2"
            ...
            <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn btn-soft-success btn-sm mr-2 select-all-options">

                    Select All

                </button>

                <button type="button" class="btn btn-soft-danger btn-icon btn-circle remove-group">
    ...
    <div class="card-body addon-body" style="display:none;">
        ...
        <div class="text-center mt-3">
            ...
            <button type="button" class="btn btn-soft-primary btn-sm add-option-btn">
