...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4 d">
    ...
    <div class="row ">
        <div class="col-sm-6 col-md-6 col-xxl-3 ">
            <div class="card shadow-none mb-4  py-4 box">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col ">
                            <p class="small text-muted-black mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-black">{{ translate('Products') }}</span>
                            </p>
                            <h3 class="mb-0 text-black fs-30">
                        ...
                        <div class="col-auto text-right ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64.001" height="64" viewBox="0 0 64.001 64" >
                                <path id="Path_66" data-name="Path 66"
                                    ...
                                    transform="translate(-84.944 -106.382)" fill="#000" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg-white py-4 box">
                <div class="card-body ">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted-black mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-black">{{ translate('Rating') }}</span>
                            </p>
                            <h3 class="mb-0 text-black fs-30">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted-black mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-black">{{ translate('Total Order') }}</span>
                            </p>
                            <h3 class="mb-0 text-black fs-30">
                                <!--{{ \App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}-->
                                <!--{{\App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count()}}-->
                          {{      \App\Models\Order::whereHas('orderDetails', function($q) { $q->where('seller_id', auth()->id());})->count()}}
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
                                <g id="Group_25" data-name="Group 25" transform="translate(-1561.844 1020.618)">
                                    ...
                                    <path id="Path_65" data-name="Path 65"
                                        ...
                                        transform="translate(1360.615 -1125)" fill="#000" />
                                </g>
                            </svg>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-md-6 col-xxl-3">
            <div class="card shadow-none mb-4 bg- py-4 box">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted-black mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-black">{{ translate('Total Sales') }}</span>
                            </p>
                            <h3 class="mb-0 text-black fs-30">
                                @php
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64.001" viewBox="0 0 64 64.001">
                                <g id="Group_26" data-name="Group 26" transform="translate(-1571.385 1123.29)">
                                    ...
                                    <path id="Path_68" data-name="Path 68"
                                        ...
                                        transform="translate(1367.074 -1120.976)" fill="#000" />
                                </g>
                            </svg>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4 ">
            <div class="card shadow-none bg-white box">
                <div class="card-body ">
            ...
            <div class="card shadow-none bg-white mb-0 box">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none h-450px mb-0 h-100 box">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ translate('Categorized Product Count') }}
                    </div>
                    <hr>
                   @php
    $sellerId = auth()->id();

    $categories = \App\Models\Category::whereIn('id', function($query) use ($sellerId) {
...
<ul class="list-group" id="categoryList">
    ...
    @foreach ($categories->take(9) as $category)
        <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
            ...
            <span>
                {{ \App\Models\Product::where('user_id', $sellerId)
...
@if($categories->count() > 5)
    <div class="text-center mt-2">
        <button type="button" class="btn btn-sm btn-primary" id="seeMoreBtn">
            See More
        </button>
    </div>
@endif
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card h-450px mb-0 h-100 box">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ translate('Orders') }}
                                ...
                                <g id="Group_23742" data-name="Group 23742" transform="translate(2044 3467)">
                                    ...
                                    <g id="Group_23741" data-name="Group 23741" transform="translate(310 759)">
                                        <path id="Path_26908" data-name="Path 26908"
                                            ...
                                            transform="translate(-2351 -4226)" fill="#000" />
                                        <path id="Path_26909" data-name="Path 26909"
                                            ...
                                            transform="translate(-2491.298 -4498.774)" fill="000" />
                                    </g>
                                </g>
                            </svg>
                        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            @endif
            <div
                class="card mb-0 @if (addon_is_activated('seller_subscription')) px-4 py-5 @else p-5 h-100 @endif d-flex align-items-center justify-content-center box">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 ">
            <a href="{{ route('seller.money_withdraw_requests.index') }}"
                class="card mb-4 p-4 text-center bg-white h-180px box">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 ">
            <a href="{{ route('seller.products.index') }}" class="card mb-4 p-4 text-center h-180px box">
                <div class="fs-16 fw-600 text-primary">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-white box">
                <div class="fs-16 fw-600 text-primary">
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-primary">
                <h6 class="mb-0">{{ translate('Latest Products') }}</h6>
            </div>
...
@section('script')
    ...
    var expanded = btn.getAttribute('data-expanded');
    ...
    if(btn){
        btn.addEventListener("click", function(){
            ...
            if(!expanded){
                ...
                // Show More
                var hiddenItems = hiddenContainer.querySelectorAll(".hidden-item");
                ...
                // Hide Again (Reload First 5 Only)
