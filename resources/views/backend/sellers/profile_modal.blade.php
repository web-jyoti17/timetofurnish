<div class="modal-body">
  ...
  <p><i class="demo-pli-map-marker-2 icon-lg icon-fw mr-1"></i>{{ $shop->address }},<br>{{ $shop->city->name }} - {{ $shop->postal_code }}, {{ $shop->state->name }},<br> {{ $shop->country->name }} </p>
  <p><a href="{{ route('shop.visit', $shop->slug) }}" target="_blank" class="btn-link"><i class="demo-pli-internet icon-lg icon-fw mr-1"></i>{{ $shop->name }}</a></p>
