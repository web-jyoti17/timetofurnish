...
use App\Exports\SellerOrderReportExport;
    ...
    public function index(Request $request)
{
    ...
    {   
        ...
        $delivery_boys = [];
        if(!empty($order_shipping_address->city)){
    ...
    public function orderExport(Request $request)
    {
        ...
        $sortSearch = $request->query('search');
        return Excel::download(new SellerOrderReportExport($paymentStatus, $deliveryStatus, $sortSearch), 'seller_ordere_report.xlsx');
    }
