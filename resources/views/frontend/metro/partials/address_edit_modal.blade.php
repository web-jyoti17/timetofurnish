<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
           ...
           <!-- City -->
            ...
            <!--/flat-->
                        <div class="row">
                            ...
                            <!--</div>-->
                            <!--<div class="col-md-10">-->
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="" name="flat" value="{{ $address_data->flat}}" required>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            ...
                            <!--</div>-->
                            <!--<div class="col-md-10">-->
                                <input type="text" class="form-control mb-3 rounded-0" placeholder="" name="street" value="{{ $address_data->street }}" required>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <!--</div>-->
            <!--<div class="col-md-10">-->
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Your Post Code')}}" title="Please enter 6 digits Post Code"  value="{{ $address_data->postal_code }}" pattern="[0-9]{6}" name="postal_code" value="" required>
            </div>
        </div>
 ...
 <div class="row">
            ...
            <!--</div>-->
            <!--<div class="col-md-10">-->
                <input class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" name="city_id" type="text" value="{{$address_data->city_id}}"> 
        ...
        <div class="row">
            <div class="col-12 mb-3">
                <label>{{ translate('Mobile Numberr')}}</label>
            <!--</div>-->
            <!--<div class="col-md-10">-->
                <input type="text" class="form-control mb-3 rounded-0" inputmode="numeric"
           maxlength="14"
                                   onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="phone" value="{{ $address_data->phone }}" required>
            </div>
        </div>
        <!--  landline no -->
          ...
          <div class="row">
            ...
            maxlength="14"
                                   onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')"  value="{{ $address_data->landline_no }}" name="landline_no" value="" required>
            </div>
        </div>

        <!-- Save button -->
        <div class="form-group text-right">
            <button type="submit" class="btn borderbtn rounded-0 w-150px">{{translate('Save')}}</button>
        </div>
    </div>
</form>