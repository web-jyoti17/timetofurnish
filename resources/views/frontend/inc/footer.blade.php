                ...
                <a class="text-reset h-100 border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('privacypolicy') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                        ...
                        <g id="Group_24196" data-name="Group 24196" transform="translate(0 -1)">
                            ...
                            <rect id="Rectangle_18407" data-name="Rectangle 18407" width="2" height="2" transform="translate
                            (1469 2452)" fill="#919199"/>
                        </g>
                        </g>
                    </svg>
...
<section class="py-3 text-light footer-widget" style=" background-color: #dacbbc !important;">
    <div class="container">
        <!-- footer logo -->
        {{--<div class="mt-3 mb-4">
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6  justify-content-between gap-5">
                ...
                <h5 class="fs-14 fw-700  mt-3 mb-3" style="color:#000">{{ translate('Subscribe to our newsletter for regular updates about Offers, Coupons & more') }}</h5>
                <div class="mb-3">
        ...
        <!--shivani-->
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-5  footer-social  justify-content-right align-items-right">
                ...
                @if ( get_setting('show_social_links') )
                    <h5 class="fs-14 fw-700 text-secondary text-right text-uppercase mt-3 mt-lg-0">{{ translate('Follow Us') }}</h5>
                        ...
                        @if (!empty(get_setting('twitter_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('twitter_link') }}" target="_blank"
                                    class="twitter"><img src="{{ static_asset('assets/img/x-logo.png') }}" alt="{{ translate('x') }}"></a>
                            </li>
                        @endif
                        ...
                        @if (!empty(get_setting('pinterest_link')))
                            <li class="list-inline-item ml-2 mr-2">
                                <a href="{{ get_setting('pinterest_link') }}" target="_blank"
                                    class="linkedin"><i class="lab la-pinterest"></i></a>
                            </li>
                        @endif
                    </ul>
                @endif
    ...
    <div class="footer-flag-wrapper">
        ...
        <div class="flag-dropdown" id="flagDropdown">
            <a href="{{ route('language.change','en') }}">
                <img src="{{ asset('public/assets/img/usa.svg') }}">
                Coming Soon
            </a>
            <a href="{{ route('language.change','hi') }}">
                <img src="{{ asset('public/assets/img/europe.svg') }}">
                Coming Soon
            </a>
        </div>
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2 pb-2  active">
                            <a href="{{url('')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Home
                            </a>
                        </li>
                         <li class="mb-2 pb-2  active">
                            <a href="{{url('about-us')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                About Us
                            </a>
                        </li>
                        <li class="mb-2 pb-2  active">
                            <a href="{{url('categories')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Categories
                            </a>
                        </li>
                       {{-- <li class="mb-2 pb-2  active">
                            <a href="{{url('brands')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Brands
                            </a>
                        </li>--}}
                        <li class="mb-2 pb-2  active">
                            <a href="{{url('blog')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Blogs
                            </a>
                        </li>
                        <li class="mb-2 pb-2  active">
                            <a href="{{url('contact-us')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Contact Us
                            </a>
                        </li>
                      <li class="mb-2 pb-2 active">
    <a href="{{ route('career') }}" class="fs-13 text-light text-sm-secondary animate-underline-white">
        Career
    </a>
</li>
                    </ul>
            ...
            <div class="{{ $col_values }}">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @endif
                        <li class="mb-2">
                            <a class="fs-13 text-light animate-underline-white" href="{{ route('purchase_history.index') }}">
                                {{ translate('Order History') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="fs-13 text-light animate-underline-white" href="{{ route('wishlists.index') }}">
                        ...
                        @if (addon_is_activated('affiliate_system'))
                            <li class="mb-2">
                                <a class="fs-13 text-light animate-underline-white" href="{{ route('affiliate.apply') }}">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    @if (get_setting('vendor_system_activation') == 1)
                        <h4 class="fs-14 text-light text-uppercase fw-700 mb-3">{{ translate('Seller Zone') }}</h4>
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <p class="fs-13 text-soft-light mb-0"> 
                                    <a href="{{ route('shops.create') }}" class="fs-13 text-soft-light animate-underline-white" > {{ translate('Become A Seller') }} </a>
                                </p>
                            </li> 
                             
                            @guest
                                <li class="mb-2">
                                    <a class="fs-13 text-light animate-underline-white" href="{{ route('seller.login') }}">
                    ...
                    @if (addon_is_activated('delivery_boy'))
                        ...
                        <ul class="list-unstyled">
                            @guest
                                <li class="mb-2">
                                    <a class="fs-13 text-light animate-underline-white" href="{{ route('deliveryboy.login') }}">
                            ...
                            @if(get_setting('delivery_boy_app_link'))
                                <li class="mb-2">
                                    <a class="fs-13 text-light animate-underline-white" target="_blank" href="{{ get_setting('delivery_boy_app_link')}}">
                ...
                <div class="text-center text-sm-left mt-4">
                    <!-- Seller --> 
                        <h4 class="fs-14 text-light text-uppercase fw-700 mb-3">{{ translate('Be our delivery partners') }}</h4>
                        <ul class="list-unstyled">
                            
                             <li class="mb-2"> 
                                <p class="fs-13 text-soft-light mb-0"> 
                                    <a href="{{ route('become_delivery_partner') }}" class="fs-13 text-light animate-underline-white" > {{ translate('Send us Request') }} </a>
                                </p> 
                            </li> 
                        </ul> 
                </div> 
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #685b4e !important;">
                ...
                <ul class="list-unstyled">
                        <li class="mb-2 pb-2  active">
                            <a href="{{asset('')}}" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Home
                            </a>
                        </li>
                        <li class="mb-2 pb-2  active">
                            <a href="http://localhost:8082/multivendor/categories" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Categories
                            </a>
                        </li>
                          <li class="mb-2 pb-2  active">
                       ...
                       {{-- <li class="mb-2 pb-2  active">
                            <a href="http://localhost:8082/multivendor/brands" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Brands
                            </a>
                        </li>--}}
                        <li class="mb-2 pb-2  active">
                        ...
                        <li class="mb-2 pb-2  active">
                            <a href="http://localhost:8082/multivendor/contact-us" class="fs-13 text-light text-sm-secondary animate-underline-white">
                                Contact Us
                            </a>
                        </li>
                        <li class="mb-2 pb-2 active">
   ...
   class="fs-13 text-light d-flex align-items-center mb-3">
    ...
    <span>+44 7751510365</span>
                        ...
                        <li class="mb-2">
                            ...
                            <p  class="">
                                <a href="mailto:{{ get_setting('contact_email') }}" class="fs-13 text-light hov-text-primary">{{ get_setting('contact_email')  }}</a>
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #685b4e !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                         <li class="mb-2 pb-2">
                                <p class="fs-13 text-soft-light mb-0"> 
                                    <a href="{{ route('shops.create') }}" class="fs-13 text-light animate-underline-white" > {{ translate('Become A Seller') }} </a>
                                </p>
                            </li>
                        @guest
                            <li class="mb-2 pb-2 {{ areActiveRoutes(['deliveryboy.login'],' active')}}">
                                <a class="fs-13 text-light text-sm-secondary animate-underline-white" href="{{ route('seller.login') }}">
                                    {{ translate('Login to Seller Panel') }}
                                </a>
                            </li>
                        @endguest
                        @if(get_setting('seller_app_link'))
                            <li class="mb-2 pb-2">
                                <a class="fs-13 text-light text-sm-secondary animate-underline-white" target="_blank" href="{{ get_setting('seller_app_link')}}">
                                    {{ translate('Download Seller App') }}
                                </a>
                            </li>
                        @endif
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('Be our delivery partners') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #685b4e !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                         <li class="mb-2">
                                <p class="fs-13 text-light mb-0"> 
                                    <a href="{{ route('become_delivery_partner') }}" class="fs-13 text-soft-light animate-underline-white" > {{ translate('Send us Request') }} </a>
                                </p>
                            </li>
           ...
           {{-- <div class="aiz-accordion-panel bg-transparent" style="background-color: #685b4e !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                         <li class="mb-2">
                                <p class="fs-13 text-light mb-0"> 
                                    <a href="{{ route('career') }}" class="fs-13 text-soft-light animate-underline-white" > {{ translate('Send us Request') }} </a>
                                </p>
                            </li>
                ...
                <div class="text-center text-lg-left">
                    ...
                    <ul class="list-inline mb-0 logos"> 
                       <li class="list-inline-item mr-1">
                        <img class="img-fluid logo"lo src="{{ asset('public/assets/img/evri-logo.jpg') }}" alt="evri-log"  >

                        </li>
                     <li class="list-inline-item mr-1">
                        <img style="width:80px;"  class="img-fluid logo"lo src="{{ asset('public/assets/img/dhl.png') }}" alt="DHL Logo"  >

                        </li>
                        <li class="list-inline-item  mr-1">
                      <img  class="img-fluid logo" src="{{ asset('public/assets/img/ups.png') }}" alt="UPS Logo"  >

                        </li>
                        <li class="list-inline-item  mr-1">
                      <img  class="img-fluid logo" src="{{ asset('public/assets/img/royal mail.png') }}" alt="ROYAL MAIL" >

                        </li>
                        <li class="list-inline-item  mr-1">
                            <img  class="img-fluid logo" src="{{ asset('public/assets/img/dpd.png') }}" alt="DPD Logo" > 
                        </li> 
                    </ul>
                </div>
            </div>
                        ...
                        @if ( get_setting('payment_method_images') !=  null )
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item  visa-card">
                                    <img src="{{ uploaded_asset($value) }}" height="30" class="mw-100 h-auto" style="max-height: 30px" alt="{{ translate('payment_method') }}">
                                </li>
                            @endforeach
                        @endif
                    </ul>
...
<div class="col-lg-6 mb-4 mb-lg-0 mt-3">
    ...
    <span class="green-star rotate">★</span>Trustpilot
            ...
            <a href="https://www.trustpilot.com/review/timetofurnish.com" target="_blank">
                <img src="{{ asset('public/assets/img/pilot.jpg') }}" 
                     class="pilot"
            ...
            <!-- Bottom Row --> 
             ...
             <!-- Copyright -->
          {{-- <div class="col-lg-12 order-1 order-lg-0 mt-4">
                <div class="copyright fs-14 " current-verison="{{get_setting("current_version")}}">
                    {!! get_setting('frontend_copyright_text', null, App::getLocale()) !!}
                </div>
            </div>
        </div>--}}
    ...
    <!--<section class= mt-auto">-->
        <div class="container px-xs-0" > <div class="col-lg-12 order-1 order-lg-0 mt-2  mb-sm-50">
                <div class=" text-justify fs-14" current-verison="{{get_setting("current_version")}}">
                   <p class="footer-content" style="letter-spacing:1px;">We operate as an independent third-party marketplace and are not liable for the accuracy, originality, or legality of any images or content uploaded by sellers. All such materials are the sole responsibility of the seller, including any content copied or reproduced from external platforms.
Please read our   <a href="/seller-terms-conditions" target="_blank" rel="noopener"> <b>Terms and Conditions </b></p>
                </div>
            </div>
    </div>
        <!--</section>-->
...
<!-- Mobile bottom nav -->
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: #fff !important;">
...
.logo {
    width: 60px;
    height: 60px;
    object-fit: contain; /* image distortion avoid karne ke liye */
}
/* Wrapper */
.footer-flag-wrapper {
    position: relative;
