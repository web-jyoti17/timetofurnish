...
@section('content')
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center seller_login_banner" style="background-image: url({{ uploaded_asset(get_setting('admin_login_background')) }})">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-xl-4 mx-auto">
                <div class="card z-2 text-left">
                    <div class="card-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text password-toggle-icon">
                                            <i class="las la-eye"></i> <!-- Initially open eye icon -->
                                            <i class="las la-eye-slash d-none"></i> <!-- Closed eye icon -->
                                        </span>
                                    </div>
                                </div>
