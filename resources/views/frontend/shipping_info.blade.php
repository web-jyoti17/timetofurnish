                        ...
                        @if (Auth::check())
                            ...
                            <div class="bg-white p-3 mb-3 rounded shadow-sm">
                                            ...
                                            <div>
                                                <div><strong>{{ optional($address->country)->name }}</strong>
                                                    @if ($address->set_default)
                                                        <span
                                                            class="badge bg-primary ms-2">{{ translate('Default') }}</span>
                                                    @endif
                                                </div>
                                                <div>
                                ...
                                @if ($addresses_count < $max_addresses)
                                    <div class="border border-dashed rounded bg-light p-3 text-center cursor-pointer mb-3"
                                        onclick="add_new_address();" style="cursor:pointer;">
