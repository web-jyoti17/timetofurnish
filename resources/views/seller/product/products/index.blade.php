    ...
    <div class="card">
        <form class="" id="sort_products" action="" method="GET">
            <div class="card-header row gutters-5">
               ...
               {{-- <div class="col-auto">
    <a href="{{ route('seller.products.download.pdf') }}" class="btn btn-success btn-sm">
    Download PDF
</a>
    </div>--}}
               <div class="col-md-3">
...
<div class="col-md-3">
    ...
    {{ translate('Current Qty')}}
                       ...
                       {{--     <th data-breakpoints="md" class="text-left text-nowrap">{{translate('Total Stock')}}</th>--}}
                            ...
                            @endif
                            <th data-breakpoints="md" class="text-left text-nowrap">{{ translate('Published')}}</th>
                            <th data-breakpoints="md" class="text-left text-nowrap">{{ translate('Featured')}}</th>
                            <th data-breakpoints="md" class="text-left text-nowrap">{{ translate('Options')}}</th>
                        </tr>
                    </thead>
                                    ...
                                    <div class="row gutters-5 w-200px w-md-200px mw-100">
                                        <div class="col-auto">
                                            <img src="{{ uploaded_asset($product->thumbnail_img)}}" alt="Image" class="size-50px img-fit">
                                             ...
                                             @if(get_setting('product_approve_by_admin') == 1 && $product->approved == 1)
