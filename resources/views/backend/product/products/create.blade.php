                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="weight" step="0.01" value="0.00" placeholder="0.00" required>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="product_length" value='0' class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Breadth <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_breadth" value='0' class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Height <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_height" value='0' class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Weight <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_weight" value='0' class="form-control" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="hsn" value='0' class="form-control" required>
                        </div>
                    </div>
                </div>
