<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="media mb-1">
        ...
        <div class="media-body mt-2 text-left d-flex flex-column justify-content-between">
			...
			{{-- ================= Selected Addons Start ================= --}}
							@if(!empty($cart->addons))
				<div class="mt-3">
					<h6 class="fw-700 mb-2">Selected Addons</h6>

					@php
						$addons = is_array($cart->addons)
							? $cart->addons
    ...
    <div class="row gutters-5">
        <div class="col-sm-6">
            <button class="btn borderbtn  mb-3 mb-sm-0 btn-block rounded-0 text-white" data-dismiss="modal">{{ translate('Back to shopping')}}</button>
        </div>
        <div class="col-sm-6">
            <a href="{{ route('cart') }}" class="btn borderbtn mb-3 mb-sm-0 btn-block rounded-0">{{ translate('Proceed to Checkout')}}</a>
        </div>
