(function($){
	...
	$.each(all_converter,function(e){
		...
		if (numHyphen < numHyphen_next) {
		    ...
		    if (boldParents){
			item = item + '<input id="' + id_str  + '" value="'+ value +'" data-id="' + data_id + '" type="checkbox" name="'+ chk_name +'"/> <b>' + treeText + '</b> ';
		    } else {
			item = item + '<input id="' + id_str  + '" value="'+ value +'" data-id="' + data_id + '" type="checkbox" name="'+ chk_name +'"/> ' + treeText;
		    }
		    item = item + '</label><input value="'+ value +'" type="radio" name="'+ radio_name +'"/>' + "\n";
		    item = item + '<ul>' + "\n";
		    //console.log(item);
		}
		...
		if (numHyphen == numHyphen_next) {
		    item = item + '<li>' +"\n";
		    item = item + '<label ' + data_str  + '>' + "\n";
		    item = item + '<input class="hummingbird-end-node" id="' + id_str + '" value="'+ value +'" data-id="' + data_id + '" type="checkbox" name="'+ chk_name +'"/> ' + treeText;
		    item = item + '</label><input value="'+ value +'" type="radio" name="'+ radio_name +'"/>' + "\n";
		    item = item + '</li>' + "\n";
		    //console.log(item);
		}		
