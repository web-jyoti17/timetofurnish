        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                <thead class="text-black fs-12">
                    <tr>
                        <th class="pl-0">{{ translate('Order Id')}}</th>
                    ...
                    @foreach ($orders as $key => $order)
                        @if (count($order->orderDetails) > 0)
                            <tr>
                                ...
                                <!-- Date -->
                                <td class="text-black">{{ date('d-m-Y', $order->date) }}</td>
                                <!-- Amount -->
                                <td class="fw-700">
                                ...
                                <td class="text-right pr-0">
                                    ...
                                    <a href="{{route('purchase_history.details', encrypt($order->id))}}" class="btn btn-soft-info btn-icon btn-circle btn-sm hov-svg-white mt-2 mt-sm-0" title="{{ translate('Order Details') }}">
                                        ...
                                        <!--    </g>-->
                                        <!--</svg>-->
                                        <!--<i class="las la-clipboard-check" style="font-size: 24px;" ></i>-->
                                        <i class="las la-eye large-icon" style="font-size: 20px;"></i>
                                    </a>
                                    <!-- Invoice -->
                                    @if ($order->payment_status == 'paid')
