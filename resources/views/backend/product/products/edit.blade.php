        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Weight')}} <small>({{ translate('In Kg') }})</small><span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="number" class="form-control" name="weight" value="{{ $product->weight }}" step="0.01" placeholder="0.00" required>
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="col-lg-4">
               ...
               {{--<div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Dimensions</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="name">
                            ...
                            <input type="text" name="product_length" value="{{ $product->product_length }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Breadth <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_breadth" value="{{ $product->product_breadth }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Height <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_height" value="{{ $product->product_height }}" class="form-control" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                Weight <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="product_weight" value='{{ $product->product_weight }}' class="form-control" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="hsn" value='{{ $product->hsn }}' class="form-control" required>
                        </div>
                    </div>
                </div>
