...
@endphp
<!-- Card Link Overlay -->
<a href="{{ $product_url }}" style="top: 0; left: 0; z-index: 1;">

    <div class="aiz-card-box h-auto bg-white p-3 hov-scale-img modern-product-card position-relative 2">
        ...
        <div class="p-2 text-left">
            <!-- Product name -->
            <h3 class="fw-500 fs-14 text-truncate-2 lh-1-4 mb-1 modern-product-title pt-1">
            ...
            <div class="modern-card-bottom-row">
                <!-- Price Wrap (Left) -->
                <div class="fs-14 modern-price-wrap 3">
