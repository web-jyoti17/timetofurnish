                    ...
                    <div class="container">
                        <div class="d-sm-flex bg-white">
                            ...
                            <div class="px-0 pt-0 pb-3 p-sm-4">
                                <div class="w-200px h-260px mx-auto">
                            ...
                            <div class="p-0 p-sm-4 w-100 overflow-hidden">
                                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="2"
                                    data-xxl-items="3" data-xl-items="2" data-lg-items="2" data-md-items="2" data-sm-items="1"
