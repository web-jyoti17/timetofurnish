...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProductController::class)->group(function () {
         Route::get('/products/download-pdf', 'downloadProductsPdf')
       ...
       Route::get('/products', 'index')->name('products.index');
        ...
        Route::post('/products/attributes/store', 'storeAttribute')->name('products.attributes.store');
        Route::post('/products/get-addons-by-categories', 'getAddonsByCategories')->name('products.get-addons-by-categories');
    ...
    Route::controller(OrderController::class)->group(function () {
        Route::any('/order/export', 'orderExport')->name('orders.exports');
