...
use App\Exports\SellerSaleReportExport;
    ...
    public function exportSingle($id)
{
    return Excel::download(
        new SellerSaleReportExport($id),
        'seller_'.$id.'_sale_report.xlsx'
    );
}
    ...
    public function sellerSaleExport(Request $request)
    {
        return Excel::download(new SellerSaleReportExport, 'seller_sale_report.xlsx');
    }
}
