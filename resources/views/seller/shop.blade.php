    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Shop Mobile Number') }} <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Mobile Number')}}" name="phone" value="{{ $shop->phone }}"  maxlength="14"   oninput="this.value = this.value.replace(/[^0-9]/g, '')"   required>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control mb-3 aiz-selectpicker rounded-0" data-live-search="true" data-placeholder="{{ translate('Select your country')}}" name="country_id" id="edit_country" required>
             ...
             {{--   <div class="row">
                ...
                <div class="row ">
                    <lable class="col-md-2 col-form-label">{{ translate('Shop City') }}  </lable>
                    <div class="col-md-10">
                        <input class="form-control mb-3 aiz-selectpicker rounded-0" type="text" name="city_id"  value="{{ old('city_id', $shop->city_id ?? '') }}" required/> 
                    </div>
                </div>
                ...
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate('Shop Post Code') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
                        <input type="text" class="form-control mb-3" placeholder="{{ translate('Shop Post Code')}}" name="postal_code" value="{{ $shop->postal_code }}" required>
                    </div>
                </div>
               ...
               {{-- <div class="row">
                ...
                <div class="form-group mb-0 text-right">
                    <button type="submit" class="btn btn-sm borderbtn">{{translate('Save')}}</button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    @if (get_setting('google_map') == 1)
                        <div class="row mb-3">
                            ...
                            <ul id="geoData">
                                ...
                                <li style="display: none;">{{ translate('Post Code') }}: <span id="post_code"></span></li>
