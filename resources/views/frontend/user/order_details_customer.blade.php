...
@section('panel_content')
    ...
    <div class="card rounded-0 shadow-none border mb-4">
        <div class="card-header border-bottom-0">
            <h5 class="fs-16 fw-700 text-dark mb-0">{{ translate('Order Summaryy') }}</h5>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <table class="table-borderless table">
                        ...
                        <tr>
                            ...
                            <td>{{ json_decode($order->shipping_address)->address }},
                               @if(!empty(json_decode($order->shipping_address)->city)) {{ json_decode($order->shipping_address)->city }}, @endif
                                @if(isset(json_decode($order->shipping_address)->state)) {{ json_decode($order->shipping_address)->state }} - @endif
                               @if(isset(json_decode($order->shipping_address)->postal_code))   {{ json_decode($order->shipping_address)->postal_code }}, @endif
                               @if(isset(json_decode($order->shipping_address)->country))   {{ json_decode($order->shipping_address)->country }} @endif
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="card-body pb-0">
                    <table class="table-borderless table">
                        <tbody>
                            ...
                            <!--@if($order->igst)-->
                            <!--<tr>-->
                            <!--    <td class="w-50 fw-600">{{ translate('IGST') }} <small>(18%)</small></td>-->
                            <!--    <td class="text-right">-->
                            ...
                            <!--<tr>-->
                            <!--    <td class="w-50 fw-600">{{ translate('CGST') }} <small>(9%)</small></td>-->
                            <!--    <td class="text-right">-->
                            <!--        <span class="text-italic">{{ single_price($newTax) }}</span>-->
                            <!--    </td>-->
                            <!--</tr>-->
                            <!--<tr>-->
                            <!--    <td class="w-50 fw-600">{{ translate('SGST') }} <small>(9%)</small></td>-->
                            <!--    <td class="text-right">-->
                            <!--        <span class="text-italic">{{ single_price($newTax) }}</span>-->
                            <!--    </td>-->
                            <!--</tr>-->
