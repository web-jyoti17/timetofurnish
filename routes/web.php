...
Route::post('/get-attributes-by-categories', [AttributeController::class, 'getAttributesByCategories'])->name('get-attributes-by-categories');
Route::get('/shipping/cost', [AddressController::class, 'shippingCost'])->name('shipping.cost');
Route::post('/shipping/cost', [AddressController::class, 'addShippingCost'])->name('add.shipping.cost');

Route::post('/cookies/save', [CookieController::class, 'savePreferences'])->name('cookies.save');
Route::get('/cookies/accept-all', [CookieController::class, 'acceptAll'])->name('cookies.acceptAll');
...
Route::controller(AizUploadController::class)->group(function () {
    ...
    Route::post('/aiz-uploader/delete-selected', 'delete_selected_files');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::controller(PurchaseHistoryController::class)->group(function () {
        ...
        Route::get('/re-order/{id}/{status?}', 're_order')->name('re_order');
    });
