@if (count($newest_products) > 0)
    <section class="mb-2 mb-md-3 mt-2 mt-md-3 py-5" style="background:#FAF7F2">
        <div class="container">
            <!-- Top Section -->
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                <!-- Title -->
                <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                    <span class="">{{ translate('Latest Products') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
                    ...
                    <a class="text-dark fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary" href="{{ route('search',['sort_by'=>'newest']) }}">{{ translate('View All') }}</a>
            ...
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-1 position-relative">
